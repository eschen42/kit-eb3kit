...
PUPPETMODULEPATH=/etc/puppetlabs/code/modules:/opt/bibbox-install/modules

/opt/puppetlabs/bin/puppet apply --modulepath=$PUPPETMODULEPATH  /vagrant/environments/production/manifests/config-ubuntu.pp
/opt/puppetlabs/bin/puppet apply --modulepath=$PUPPETMODULEPATH  /vagrant/environments/production/manifests/config-packages.pp
